...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative z-10 w-full bg-surface-container border-t border-surface-container mt-auto safe-bottom">
              ...
              <div className="flex gap-3 pt-2">
                {settings.social_instagram && (
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-surface flex items-center justify-center text-on-surface-variant hover:bg-primary hover:text-on-primary transition-colors"
      ...
      <div className="border-t border-surface-high">
        <div className="w-full px-margin-mobile md:px-margin-desktop py-stack-md">
          <div className="max-w-container-max mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-label-sm text-on-surface-variant text-center md:text-left order-2 md:order-1">
              &copy; {new Date().getFullYear()} {settings.site_name || 'KostFind'}. Hak cipta dilindungi.
            </p>
