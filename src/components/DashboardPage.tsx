            ...
            <div className="px-4 pt-4">
              <div className="flex items-center gap-3 p-3 bg-emerald-50/60 rounded-2xl border border-emerald-100/40">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <span className="text-[10px] font-bold text-emerald-700 uppercase tracking-wide">Pemilik Kost</span>
                </div>
              </div>
            </div>
        ...
        <div className={`space-y-8 ${isSidebarCollapsed ? 'p-3' : 'p-5'}`}>
          ...
          {!isSidebarCollapsed ? (
            <div className="flex items-center gap-3 px-3 py-3 bg-emerald-50/50 rounded-xl border border-emerald-100/30 shadow-sm">
              <div className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 border border-emerald-200 shrink-0 overflow-hidden">
                {user?.avatar_url ? <img src={user.avatar_url} alt={user.name} className="w-full h-full object-cover" /> : <User className="w-5 h-5" />}
              </div>
              <div className="min-w-0 flex-1 text-left">
                <p className="text-sm font-extrabold text-slate-900 leading-tight truncate">{user?.name || 'Pemilik Kost'}</p>
                <span className="text-[10px] font-bold text-emerald-700 uppercase tracking-wide block mt-0.5">Pemilik Kost</span>
              </div>
            </div>
          ) : (
            <div className="flex justify-center">
              <div className="w-10 h-10 rounded-full bg-emerald-100/50 flex items-center justify-center text-emerald-600 border border-emerald-200 overflow-hidden" title={user?.name || 'Pemilik Kost'}>
                {user?.avatar_url ? <img src={user.avatar_url} alt={user.name} className="w-full h-full object-cover" /> : <User className="w-5 h-5" />}
              </div>
            </div>
          )}
          ...
          <nav className="flex flex-col gap-1">
            ...
            <div className="space-y-1 w-full mb-4">
              ...
              <button
                ...
                } ${activeSection === 'overview' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100/30 font-bold' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'}`}
                title="Dasbor"
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 transition-colors cursor-pointer ${
                  isSidebarCollapsed ? 'justify-center rounded-xl w-10 h-10 mx-auto p-0' : 'rounded-xl text-sm font-medium animate-in fade-in duration-200'
                } ${activeSection === 'properties' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100/30 font-bold' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'}`}
                title="Kost"
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 transition-colors cursor-pointer ${
                  isSidebarCollapsed ? 'justify-center rounded-xl w-10 h-10 mx-auto p-0' : 'rounded-xl text-sm font-medium animate-in fade-in duration-200'
                } ${activeSection === 'finance' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100/30 font-bold' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'}`}
                title="Keuangan"
              >
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 transition-colors cursor-pointer ${
                  isSidebarCollapsed ? 'justify-center rounded-xl w-10 h-10 mx-auto p-0' : 'rounded-xl text-sm font-medium animate-in fade-in duration-200'
                } ${activeSection === 'orders' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100/30 font-bold' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'}`}
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 transition-colors cursor-pointer ${
                  isSidebarCollapsed ? 'justify-center rounded-xl w-10 h-10 mx-auto p-0' : 'rounded-xl text-sm font-medium animate-in fade-in duration-200'
                } ${activeSection === 'chat' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100/30 font-bold' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'}`}
                title="Pesan"
              >
            ...
            <div className="space-y-1 w-full">
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 transition-colors cursor-pointer ${
                  isSidebarCollapsed ? 'justify-center rounded-xl w-10 h-10 mx-auto p-0' : 'rounded-xl text-sm font-medium animate-in fade-in duration-200'
                } ${activeSection === 'settings' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100/30 font-bold' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100'}`}
                title="Pengaturan"
              >
        ...
        <header className="hidden md:flex h-16 border-b border-slate-200 bg-white items-center justify-between px-8 shrink-0 relative z-30">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              >
                <div className="w-7 h-7 rounded-lg bg-emerald-100 overflow-hidden border border-slate-200 flex-shrink-0 flex items-center justify-center text-emerald-600 text-xs font-black">
                  {user?.avatar_url ? (
