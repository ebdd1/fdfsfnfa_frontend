    ...
    <div className="bg-slate-50 min-h-screen p-4 sm:p-6 md:p-8 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {watchedProperties.length === 0 ? (
          <div className="bg-white rounded-3xl p-12 text-center border border-slate-200/80 shadow-sm flex flex-col items-center justify-center space-y-4 min-h-[350px]">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl shadow-sm transition-all active:scale-95 flex items-center gap-1.5 cursor-pointer mt-2"
            >
            ...
            {watchedProperties.map((p) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-3xl overflow-hidden border border-slate-200/60 shadow-sm hover:shadow-md hover:border-emerald-500/30 transition-all duration-300 cursor-pointer group flex flex-col relative"
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
                    <div className="space-y-2 text-left">
                      ...
                      <h3 className="text-base font-extrabold text-slate-800 group-hover:text-emerald-600 transition-colors line-clamp-1">
                        {p.name}
                      </h3>
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={handleCreateAlert} className="bg-white rounded-3xl p-6 border border-slate-200/85 shadow-sm space-y-5">
          ...
          <div className="text-left space-y-1.5">
            ...
            <input
              ...
              className="w-full text-xs rounded-xl border-slate-200 bg-slate-50/50 focus:bg-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all py-2.5 px-3"
            />
          </div>
          ...
          <div className="text-left space-y-1.5">
            ...
            <select
              ...
              className="w-full text-xs rounded-xl border-slate-200 bg-white focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all py-2.5 px-3"
            >
          ...
          <button
            type="submit"
            className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-all active:scale-95 shadow-sm cursor-pointer"
          >
        ...
        <div className="space-y-3">
          ...
          {alerts.map((a) => (
            <div key={a.id} className="bg-white rounded-2xl p-4 border border-slate-200/60 shadow-sm flex items-center justify-between hover:border-emerald-500/30 transition-all duration-300">
